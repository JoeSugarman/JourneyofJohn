...
public class JapanVn3V1 : MonoBehaviour
{
    DialogueSystem ds;
    ...
    IEnumerator RotateBigDisciple()
    {
        ...
        Vector3 initialPosition = bigjohn.rectTransform.localPosition;
        ...
        while (elapsed < duration)
        {
            ...
            bigjohn.rectTransform.localPosition = Vector3.Lerp(initialPosition, targetPosition, elapsed / duration);
